<h2><a href="https://leetcode.com/problems/split-array-into-consecutive-subsequences/?envType=problem-list-v2&envId=greedy">649. Dota2 Senate</a></h2><h3>Medium</h3><hr><p>In the world of Dota2, there are two parties: the Radiant and the Dire.</p>
